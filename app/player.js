...
(function (RacingGame) {
  class Player {
    ...
    move() {
      ...
      this.manager.engine.cameraGroup.position.z =
        this.refPlayerModel.position.z;
      $("#speedData").html("" + Math.floor(this.speed));
      if (
        this.refPlayerModel.position.z < -1110 &&
        this.manager.gameState === RacingGame.GameState.Running
      ) {
